...
tcpData = ['1935', 'Chrome_Child', '4', '192.168.2.4',
           '142.251.42.234', '443', 'optimizationguide-pa.googleapis.com']
...
# print('123')
# test.funSql(test.sqlData, tcpData)
